...
import ModalDetailProductClinet from '../../../forms/client/Modal-Detail-SanPham-Client';

// ----------------------------------------------------------------------

ProductListClinetTimeline.propTypes = {
...
export default function ProductListClinetTimeline({products, getDetailHD, selectDataCart, DataCart, ...other}) {
